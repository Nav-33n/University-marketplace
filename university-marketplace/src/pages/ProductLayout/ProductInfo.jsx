...
function ProductInfo() {
  ...
  return (
    <div className="grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-2 border-b-4 rounded pb-2 border-[#ced7dfbb]">
      ...
      <div className="flex flex-col justify-between h-full min-h-[400px] px-4">
        ...
        <nav className="mt-6">
          <NavLink>
            <button className="w-full py-3 text-center bg-cyan-500 hover:bg-cyan-800 rounded-md font-normal mb-4 text-white cursor-pointer">
              Send Offer
            </button>
          </NavLink>
          <NavLink
          ...
          <div className="flex justify-between mb-1 mt-2">
            ...
            >
              <MessagesSquare className="text-black ml-20 mr-1 w-3 h-3" />
            ...
            >
              <Heart className="text-black mr-1 w-3 h-3" />
            ...
            >
              <Share2 className="text-black mr-1 w-3 h-3" />
              <span className="font-semibold text-black mr-20">Share</span>
            </NavLink>
          </div>
        </nav>
      </div>
